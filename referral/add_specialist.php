...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $stmt = $conn->prepare("
            INSERT INTO specialists (nsr_number, name, department_id, specialization, 
                                   email, phone, status, profile, picture, password)
            VALUES (:nsr_number, :name, :department_id, :specialization, 
                    :email, :phone, :status, :profile, :picture, :password)
        ");
        ...
        $error_message = "An error occurred while adding the specialist.";
        // Clean up uploaded file if database insert failed
        if (isset($picture_path) && file_exists($picture_path)) {
            unlink($picture_path);
        }
    }
}
...
<head>
    ...
    <title>Add Specialist - Hospital Admin</title>
    ...
    <div class="container mt-4">
        ...
        <form method="POST" class="card p-4" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="profile" name="profile" rows="6"></textarea>
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Upload a professional photo of the specialist (JPEG, PNG formats recommended)</small>
            </div>
            ...
            <div class="card mb-3 p-3 bg-light">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="Same as email above" disabled>
                    <small class="form-text text-muted">The specialist will use their email address to login</small>
                </div>
                <div class="mb-3">
